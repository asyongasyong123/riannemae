  ...
  "inbounds": [
...

    {
      ...
      "settings": {
        "clients": [
          {
            "id": "mabaitakokapagmabaitka",

            "level": 0,

            "email": "vless-riannemae"
          }
        ],
